const LayerExplosion = function (t) {
    function e() {
        var e = t.call(this) || this;
        return e._under_layer = new PIXI.Sprite,
            e._over_layer = new PIXI.Sprite,
            e.addChild(e._under_layer),
            e.addChild(e._over_layer),
            e
    }
    return n(e, t),
        e.prototype.playDamageExplosion = function (t, e, i, n) {
            void 0 === n && (n = null),
                i < 0 ? null != n && n() : i < 16 ? this.playExplosionSmall(t, e, n) : i < 40 ? this.playExplosionMiddle(t, e, n) : this.playExplosionLarge(t, e, n)
        }
        ,
        ...
        e.prototype.playExplosions = function (t, e, i) {
            var n = this;
            void 0 === i && (i = null),
                createjs.Tween.get(null).wait(166).call(function () {
                    ...
                    n._explode(t + 81, e + 44),
                        n._explode(t - 89, e - 53)
                }).wait(33).call(function () {
        ...
        e.prototype.playTorpedoWaterColumn = function (t, e) {
            ...
            i.y += o.BannerSize.H / 2,
                1 == t.friend ? (i.x += o.BannerSize.W / 2 + 45,
                    this.playTorpedoWaterColumnToFriend(i.x, i.y, e)) : (i.x -= o.BannerSize.W / 2 + 45,
                        this.playTorpedoWaterColumnToEnemy(i.x, i.y, e))
        }
        ,
        e.prototype.playTorpedoWaterColumnToFriend = function (t, e, i) {
            void 0 === i && (i = null),
                this._playTorpedoWaterColumn(!0, t, e, i)
        }
        ,
        e.prototype.playTorpedoWaterColumnToEnemy = function (t, e, i) {
            void 0 === i && (i = null),
                this._playTorpedoWaterColumn(!1, t, e, i)
        }
        ,
        ...
        e.prototype.playWaterColumnToFriend = function (t, e, i) {
            void 0 === i && (i = null),
                this._playWaterColumn(!0, t, e, i)
        }
        ,
        e.prototype.playWaterColumnToEnemy = function (t, e, i) {
            void 0 === i && (i = null),
                this._playWaterColumn(!1, t, e, i)
        }
        ,
